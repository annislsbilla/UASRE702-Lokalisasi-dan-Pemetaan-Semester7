...
CameraSettingsEth::CameraSettingsEth()
{
...
unsigned int *CameraSettingsEth::ptr()
{
	return buffer;
}

int CameraSettingsEth::getSize()
{
...
void CameraSettingsEth::printCameraSettings()
{
...
int CameraSettingsEth::getCameraSetting(unsigned setting)
{
	int value = -1;
...
void CameraSettingsEth::setCameraSetting(unsigned setting, unsigned value)
{
	switch(setting)
	{
	case UAV_EXPOSURE:
